...
class Model(ABC):
    ...
    def plot_history (self):
        ...
        axs[0, 0].plot(self.history.history['val_accuracy'])
        ...
        axs[0, 1].plot(self.history.history['val_f1_m'])
        ...
        axs[1, 0].plot(self.history.history['val_precision_m'])
        ...
        axs[1, 1].plot(self.history.history['val_recall_m'])
